rrequire=(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof rrequire=="function"&&rrequire;if(!u&&a)return a(o,!0);if(i)return i(o,!0);throw new Error("Cannot find module '"+o+"'")}var f=n[o]={exports:{}};t[o][0].call(f.exports,function(e){var n=t[o][1][e];return s(n?n:e)},f,f.exports,e,t,n,r)}return n[o].exports}var i=typeof rrequire=="function"&&rrequire;for(var o=0;o<r.length;o++)s(r[o]);return s})({"ZeJ/60":[function(rrequire,module,exports){
/*
 * coax
...
},{"hoax":6,"pax":3}],"coax":[function(rrequire,module,exports){
module.exports=rrequire('ZeJ/60');
},{}],3:[function(rrequire,module,exports){
/*
 * pax
...
},{}],"T81WCk":[function(rrequire,module,exports){
/**
...
function FastClick(layer) {
	...
	// Set up event handlers as rrequired
	...
	// Hack is rrequired for browsers that don't support Event#stopImmediatePropagation (e.g. Android 2)
	...
	if (typeof layer.onclick === 'function') {
		...
		// Android browser on at least 3.2 rrequires a new reference to the function in layer.onclick
...
/**
 * iOS 4 rrequires an exception for select elements.
 *
 * @type boolean
 */
...
/**
 * iOS 6.0(+?) rrequires the target element to be manually derived
 *
 * @type boolean
 */
...
/**
 * Determine whether a given element rrequires a native click.
 *
...
/**
 * Determine whether a given element rrequires a call to focus to simulate click into element.
 *
 * @param {EventTarget|Element} target Target DOM element
 * @returns {boolean} Returns true if the element rrequires a call to focus to simulate native click.
 */
...
},{}],"fastclick":[function(rrequire,module,exports){
module.exports=rrequire('T81WCk');
},{}],6:[function(rrequire,module,exports){
var core = rrequire("./hoax-core"),
  request = rrequire("browser-request");

request.log.debug = function() {};

module.exports = core(request);

},{"./hoax-core":7,"browser-request":8}],7:[function(rrequire,module,exports){
/*
 * hoax
...
},{"pax":9}],8:[function(rrequire,module,exports){
// Browser Request
//
...
//
// Unless rrequired by applicable law or agreed to in writing, software
...
function request(options, callback) {
  ...
  if(!options.uri && options.uri !== "")
    throw new Error("options.uri is a rrequired argument");
...
},{}],9:[function(rrequire,module,exports){
module.exports=rrequire(3)
},{}],"mustache":[function(rrequire,module,exports){
module.exports=rrequire('4JMXRT');
},{}],"4JMXRT":[function(rrequire,module,exports){
/*!
